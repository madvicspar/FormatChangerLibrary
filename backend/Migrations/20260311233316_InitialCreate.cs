...
namespace FormatChanger.Backend.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextHeadingLevelId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeadingSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HeadingSettings_HeadingSettings_NextHeadingLevelId",
                        column: x => x.NextHeadingLevelId,
