...
namespace FormatChanger.Services.Strategies
{
	public class ImageCorrectionStrategy : ElementCorrectionStrategyBase<ImageSettingsModel>
	{
		...
		public override void ApplyCorrection(WordprocessingDocument doc, FormattingTemplateModel template)
		{
			...
			{
				// TODO: text run properties should probably also be corrected for image paragraphs
		...
		/// <summary>
		/// Checks image paragraph formatting by reading properties directly —
		/// exactly as GetParagraphProperties writes them (raw values, no style hierarchy).
		/// </summary>
