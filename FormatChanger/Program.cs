...
builder.Services.AddScoped<IElementCorrectionStrategy<ImageSettingsModel>>(sp => sp.GetRequiredService<ImageCorrectionStrategy>());
...
using (var scope = app.Services.CreateScope())
{
    ...
    await dbContext.InitializeAsync(app.Environment.IsDevelopment(), scope.ServiceProvider, userManager, roleManager);
}
