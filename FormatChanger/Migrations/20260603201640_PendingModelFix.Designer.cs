...
namespace FormatChanger.Migrations
{
    ...
    [Migration("20260603201640_PendingModelFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.FormattingTemplateModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.HeaderSettingsModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.HeadingSettingsModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.ICaptionSettingsModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.ImageSettingsModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.TextSettingsModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.ImageCaptionSettingsModel", b =>
                {
                    b.HasBaseType("FormatChanger.Models.FormattingModels.ICaptionSettingsModel");

                    b.HasDiscriminator().HasValue("Image");
                });

            modelBuilder.Entity("FormatChanger.Models.FormattingModels.TableCaptionSettingsModel", b =>
                {
                    b.HasBaseType("FormatChanger.Models.FormattingModels.ICaptionSettingsModel");
            ...
            modelBuilder.Entity("FormatChanger.Models.CorrectionResultsModel", b =>
                {
                    ...
                    b.HasOne("FormatChanger.Models.FormattingModels.FormattingTemplateModel", "FormattingTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.FormattingTemplateModel", b =>
                {
                    ...
                    b.HasOne("FormatChanger.Models.FormattingModels.HeadingSettingsModel", "HeadingSettings")
                        .WithMany()
                        .HasForeignKey("HeadingSettingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FormatChanger.Models.FormattingModels.ImageSettingsModel", "ImageSettings")
                        .WithMany()
                        .HasForeignKey("ImageSettingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FormatChanger.Models.FormattingModels.ListSettingsModel", "ListSettings")
                        .WithMany()
                        .HasForeignKey("ListSettingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FormatChanger.Models.FormattingModels.TableSettingsModel", "TableSettings")
                        .WithMany()
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.HeaderSettingsModel", b =>
                {
                    b.HasOne("FormatChanger.Models.FormattingModels.CellSettingsModel", "CellSettings")
                        .WithMany()
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.HeadingSettingsModel", b =>
                {
                    b.HasOne("FormatChanger.Models.FormattingModels.HeadingSettingsModel", "NextHeadingLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.ImageSettingsModel", b =>
                {
                    b.HasOne("FormatChanger.Models.FormattingModels.ICaptionSettingsModel", "CaptionSettings")
                        .WithMany()
            ...
            modelBuilder.Entity("FormatChanger.Models.FormattingModels.TableSettingsModel", b =>
                {
                    ...
                    b.HasOne("FormatChanger.Models.FormattingModels.HeaderSettingsModel", "HeaderSettings")
                        .WithMany()
